...
function loadNextQuestion () {
    ...
    if(currentQuestion == totalQuestions) {
        ...
        result.innerHTML =
         ...
         <div class="summary">
            <h1>Summary</h1>
            <p>See below for a summary based on your results:</p>
            <p>Based on your choices, you seem to lean towards majors that express your artistic and creative side. </p>
            <p>Possible options include but are not limited to: Art, Architecture, Music, Marketing</p>
            <p>To explore possible major options, click here: </p>
        </div>
